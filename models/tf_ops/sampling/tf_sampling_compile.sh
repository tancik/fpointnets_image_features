...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I ~/miniconda3/envs/tf1.10/lib/python3.5/site-packages/tensorflow/include -I /usr/local/cuda-9.2/include -I ~/miniconda3/envs/tf1.10/lib/python3.5/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-9.2/lib64/ -L ~/miniconda3/envs/tf1.10/lib/python3.5/site-packages/tensorflow -ltensorflow_framework -O2 #-D_GLIBCXX_USE_CXX11_ABI=0
